...
Color_t Scene::shading(const class Ray & ray, const class Object & object, double t, int depth) {
    ...
    switch(object.texture) {
        ...
        default:
            throw exception();// UNRECOGNIZED_TEXTURE
    }
}

Color_t Scene::trace(int x, int y) {
...
Color_t Scene::trace_ray(const Ray& ray, const Object* exclude_obj, int depth) {
...
bool Scene::check_occlusion(Vec3 target, Vec3 source) {
